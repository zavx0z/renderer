...
## DOM-CORE-026 — документация владельца

Публичный контракт DOM описывается в README и TSDoc пакета. Исполняемые
сценарии поведения принадлежат его обычным тестам.
