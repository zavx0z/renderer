...
export {DOMRectReadOnly} from "./dom-rect.ts"
export type {DOMRectInit} from "./dom-rect.ts"
...
export {attachDocumentRenderReadAdapter} from "./render-read.ts"
export type {DocumentRenderReadAdapter} from "./render-read.ts"
